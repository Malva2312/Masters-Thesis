...
\begin{Prolog}
  \include{chapters/prolog/abstract} % the abstract
  \include{chapters/prolog/un-sdg}   % United Nations Sustainable Development Goals (SGD)
  %\include{chapters/prolog/acknows}  % the acknowledgments
  \include{chapters/prolog/quote}    % initial quotation if desired
  \cleardoublepage
  ...
  \include{chapters/prolog/abbrevs}  % the list of abbreviations used
\end{Prolog}
...
% \include{chapters/examples/chapter2}
% \include{chapters/examples/chapter3}
%% Uncomment to see a listing example
%\include{chapters/examples/chapter45-listing}

\include{chapters/intro} 
%% \include{chapters/lreview} %% Needed only for PDIS
%% \include{chapters/protocol} %% Needed only for PDIS
