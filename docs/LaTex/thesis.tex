...
\usepackage[meic,final,backrefs]{feupteses}
...
\degree{Master in Informatics and Computation Engineering}

%% Uncomment next line for date of submission
\thesisdate{Jannuary 17, 2025}

%% Comment next line copyright text if not used
\copyrightnotice{João Malva, 2025}

\supervisor{Supervisor}{Eduardo Rodrigues}
...
\include{./chapters/c1_intro} 
\include{./chapters/c2_lreview}
\include{chapters/c3_sota}
\include{chapters/c4_protocol}
