...
from src.modules.model.fusion_feature.convnext.convnext_fused_model import ConvNext_Fused_Model
from src.modules.loss_functions.convnext_loss_functions import ConvNextLossFunction

class PyTorchLightningConvNextFusedModel(pytorch_lightning.LightningModule):
   
    def __init__(self, config, experiment_execution_paths):
        super().__init__()
        self.config = config

        self.criterion = ConvNextLossFunction(
            config=self.config.convnext_config.criterion,
            experiment_execution_paths=experiment_execution_paths
        )

        self.model = ConvNext_Fused_Model(config=self.config)
