...
from src.modules.model.standalone.alexnet.alexnet_model import AlexNetModel
from src.modules.loss_functions.alexnet_loss_functions import AlexNetLossFunction

class PyTorchLightningAlexNetModel(pytorch_lightning.LightningModule):
    def __init__(self, config, experiment_execution_paths):
        super().__init__()
        self.config = config
        self.criterion = AlexNetLossFunction(
            config=self.config.alexnet_config.criterion,
            experiment_execution_paths=experiment_execution_paths
        )
        self.labels = None
        self.model = AlexNetModel(config=self.config)
