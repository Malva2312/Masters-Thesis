...
from src.modules.model.standalone.googlenet.googlenet_model import GoogLeNetModel
from src.modules.loss_functions.googlenet_loss_functions import GoogLeNetLossFunction

class PyTorchLightningGoogLeNetModel(pytorch_lightning.LightningModule):
    def __init__(self, config, experiment_execution_paths):
        super().__init__()
        self.config = config
        self.criterion = GoogLeNetLossFunction(
            config=self.config.googlenet_config.criterion,
            experiment_execution_paths=experiment_execution_paths
        )
        self.labels = None
        self.model = GoogLeNetModel(config=self.config)
